package com.example.administrator.signin.CoursePackge;
...
public class CourseTableView extends RelativeLayout {
    ...
    public CourseTableView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.d("my","public CourseTableView(Context context, AttributeSet attrs, int defStyleAttr) {");
    ...
    public CourseTableView(Context context, AttributeSet attrs) {
        ...
        Log.d("my","public CourseTableView(Context context, AttributeSet attrs) {");
    }

    public CourseTableView(Context context) {
        this(context, null);
        Log.d("my"," public CourseTableView(Context context) {");
    }
    ...
    public void setOnCourseItemClickListener(OnCourseItemClickListener onCourseItemClickListener) {
        Log.d("my","setOnCourseItemClickListener");
    ...
    public void clearViewsIfNeeded() {
        if (myCacheViews == null || myCacheViews.isEmpty()) {
            Log.d("my","clearViewsIfNeeded+myCacheViews == null || myCacheViews.isEmpty()");
            return;
        }
        for (int i = myCacheViews.size() - 1; i >= 0; i--) {
            Log.d("my",myCacheViews.toString());
    ...
    private String[] getOneWeekDatesOfMonth() {
        Log.d("my","getOneWeekDatesOfMonth");
        Calendar toDayCal = Calendar.getInstance();
        toDayCal.setTimeInMillis(System.currentTimeMillis());
    ...
    private int getScreenWidth() {
        ...
        Log.d("my","getScreenWidth"+ displayMetrics.widthPixels);
    ...
    private int getScreenHeight() {
        ...
        WindowManager wm = (WindowManager) getContext().getSystemService(Context.WINDOW_SERVICE);
        wm.getDefaultDisplay().getMetrics(displayMetrics);
        Log.d("my","getScreenHeight"+ displayMetrics.heightPixels);
